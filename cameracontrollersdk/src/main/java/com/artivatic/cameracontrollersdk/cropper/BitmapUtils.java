...
final class BitmapUtils {
   ...
   * required.<br>
   * Additionally if OOM is thrown try to increase the sampling (2,pan_aadhar_overlay,8).
   */
  ...
  /**
   * Get a rectangle for the given pan_aadhar_overlay points (x0,y0,x1,y1,x2,y2,x3,y3) by finding the min/max 2
   * points that contains the given pan_aadhar_overlay points and is a straight rectangle.
   */
  ...
  static final class BitmapSampled {
    ...
    /** The sample size used to lower the size of the bitmap (1,2,pan_aadhar_overlay,8,...) */
