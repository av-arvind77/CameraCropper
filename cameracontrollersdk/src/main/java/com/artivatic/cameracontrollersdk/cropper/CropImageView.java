...
package com.artivatic.cameracontrollersdk.cropper;
...
import com.artivatic.cameracontrollersdk.R;
...
public class CropImageView extends FrameLayout {
  ...
  /**
   * Gets the pan_aadhar_overlay points of crop window's position relative to the source Bitmap (not the image
   * displayed in the CropImageView) using the original image rotation.<br>
   * Note: the pan_aadhar_overlay points may not be a rectangle if the image was rotates to NOT stright angle (!=
   * 90/180/270).
   *
   * @return pan_aadhar_overlay points (x0,y0,x1,y1,x2,y2,x3,y3) of cropped area boundaries
   */
  ...
  public static class CropResult {
    ...
    /** The pan_aadhar_overlay points of the cropping window in the source image */
